...
[![Star](https://img.shields.io/github/stars/renatoromao/dio-primeiro-copilot-studio?style=social)](https://github.com/renatoromao/dio-primeiro-copilot-studio/stargazers)
[![Forks](https://img.shields.io/github/forks/renatoromao/dio-primeiro-copilot-studio?style=social)](https://github.com/renatoromao/dio-primeiro-copilot-studio/forks)
[![GitHub Issues](https://img.shields.io/github/issues/renatoromao/dio-primeiro-copilot-studio?style=social)](https://github.com/renatoromao/dio-primeiro-copilot-studio/issues/)

 Este é um projeto feito para a comunidade, então sinta-se livre para contribuir. Algumas formas de contribuição além do seu exemplo de Profile README, é inserir outros utilitários na pasta [`utils`](https://github.com/renatoromao/dio-primeiro-copilot-studio/tree/main/utils), ou melhorar a página de pesquisa dos READMEs fazendo modificações nos arquivos da pasta [`docs`](https://github.com/renatoromao/dio-primeiro-copilot-studio/tree/main/docs). <br>
...
##  Contribuindo no diretório "Community" 
 ...
 Inspire-se consultando os exemplos na pasta [`community`](https://github.com/renatoromao/dio-primeiro-copilot-studio/tree/main/community), confira alguns utilitários na pasta [`utils`](https://github.com/renatoromao/dio-primeiro-copilot-studio/tree/main/utils) e use sua criatividade para criar o seu 😊💙.
...
```bash
git clone https://github.com/SEU_USERNAME/dio-primeiro-copilot-studio.git
```
...
### 4) Crie o seu Profile README
 Dentro da pasta [`community`](https://github.com/renatoromao/dio-primeiro-copilot-studio/tree/main/community), crie um arquivo em Markdown (extensão `.md`) e nomeie com o mesmo nome do seu usuário no GitHub:

> Exemplo: `community/falvojr.md`

#### 4.1) Desenvolva o seu Profile README
Para isso, você pode se inspirar nos exemplos no diretório [`community`](https://github.com/renatoromao/dio-primeiro-copilot-studio/tree/main/community) e adicionar alguns dos utilitários presentes na pasta [`utils`](https://github.com/renatoromao/dio-primeiro-copilot-studio/tree/main/utils)
...
```
>[!IMPORTANT]
> Verifique a [`Convenção de Commits`](https://github.com/renatoromao/dio-primeiro-copilot-studio/blob/main/README.md#conven%C3%A7%C3%A3o-de-commits) para escrever a mensagem do seu commit de forma clara e padronizada.
